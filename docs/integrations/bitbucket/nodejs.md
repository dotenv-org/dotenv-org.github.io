...
{% include helpers/screenshot.html url="https://res.cloudinary.com/dotenv-org/image/upload/v1669139672/integrations/dotenv_vault_bitbucket_environment_variable_settings_c4ofat.png" %}
...
{% include helpers/screenshot.html url="https://res.cloudinary.com/dotenv-org/image/upload/v1669139673/integrations/dotenv_vault_bitbucket_logs_encrypted_loading_env_vault_hzdez2.png" %}
